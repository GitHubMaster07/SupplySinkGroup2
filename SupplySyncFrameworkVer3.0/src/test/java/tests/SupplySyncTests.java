...
import pages.SupplySyncCreateCompanyPage;
...
public class SupplySyncTests {
    ...
    private SupplySyncLoginPage supplySyncLoginPage;
    private SupplySyncCreateCompanyPage supplySyncCreateCompanyPage;
